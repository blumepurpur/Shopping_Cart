            ...
            ?>        
             ...
             <div class="contact-form">
				<h2>Please Fill in the form below</h2>
                             ...
                             <form action="login.php" method="post" class="ajax_form" >
                               ...
                               <div class="row field_text alignleft">
                                ...
                                <div class="row field_text alignleft">
                                    ...
                                    <input name="password"  type="password" id="password" class="inputtext input_middle required"  placeholder=" enter your passowrd" size="40" />
                                </div>
                                <div class="clear"></div>
