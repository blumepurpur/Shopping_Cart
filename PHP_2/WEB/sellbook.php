...
<div class="container">
	...
	<div class="header-title-image">
    	...
    	<h1><span>Please fill the</span> form </h1>
    </div>
    ...
    <div class="container_24">
        ...
        if (isset($_POST["username"])) {
           ...
           $sellbook = sellbook::register($username,$surname,$email,$price,$message);           
           
            if($sellbook != null)
                 {
                     echo "Welcome " . $sellbook->username . " " . $sellbook->email;
                 }
            ...
            ?>        
              <div class="contact-form">
				<h2>Please Fill in the form below</h2>
                            ...
                            <form action="sellbook.php" method="post" class="ajax_form" >
                              <div class="row field_text alignleft">
                           	    <label>your username (required):</label><br />
                                 <input  name="username" class="inputtext input_middle required" size="20" placeholder=" Your user name" type="text" />
                                </div>
                                
								
				<div class="row field_text alignleft">
                                	<label>Your surname (required):</label><br />
                                    <input name="surname" class="inputtext input_middle required" size="40" type="text" />
                                </div>
                                
                                <div class="row field_text alignleft">
                                	<label>Your email (required):</label><br />
                                    <input name="email" class="inputtext input_middle required" size="40" type="text" />
                                </div>
								
					
                                
                                    <div class="row field_text alignleft">
                                	<label>Book price(required):</label><br />
                                    <input name="price" class="inputtext input_middle required" size="40" type="text" />
                                </div>
