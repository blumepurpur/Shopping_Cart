...
class User {
    ...
    public static function login($username, $password) {
        ...
        try {
            ...
            $result = $db->prepare("Select * from User where username=:un and password=:pw");

            $result->bindValue(":un", $username);
    ...
    public static function product_details($product_id) {
        ...
        foreach ($table as $product) {
            ...
            echo "<td>$name</td><td>$price</td><td><input name='$id' type='text' size='2'/></a></td>";
            echo "</tr>";
        }
